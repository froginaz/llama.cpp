...
- [12-context-model-backend-ownership.md](12-context-model-backend-ownership.md) — `llama_context` / `llama_model` / ggml-backend relationships, ownership, and lifecycle (Korean), with PlantUML sources: [class diagram](12-class-diagram-ownership.puml), [lifecycle sequence](12-sequence-lifecycle.puml), [object lifetime](12-object-lifetime.puml).
